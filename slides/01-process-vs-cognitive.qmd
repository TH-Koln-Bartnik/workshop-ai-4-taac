...
# Einstieg — eine Rechnung, drei Automatisierungsstufen {background-color="#c81e0f"}

::: {style="text-align: center; margin-top: 1.5em; color: #ffffff;"}

**Animation starten**

[https://th-koln-bartnik.github.io/workshop-ai-4-taac/interactions/eingangsrechnung-automatisierung.html](https://th-koln-bartnik.github.io/workshop-ai-4-taac/interactions/eingangsrechnung-automatisierung.html){style="color: #ffffff; font-size: 1.0em;"}

:::

::: notes
Zehn Eingangsrechnungen laufen denselben Sechs-Schritt-Prozess einmal manuell, einmal mit Prozessautomation, einmal mit kognitiver Automation. Tasten 1 bis 3 wechseln die Stufe, Leertaste startet und pausiert. Laufen lassen, ohne die Begriffe vorher zu nennen. Frage an die Gruppe: Was ändert sich zwischen den drei Stufen, was bleibt gleich? Die Antworten münden direkt in die nächste Folie.
:::
...
[https://th-koln-bartnik.github.io/workshop-ai-4-taac/interactions/diagnose-quiz.html](https://th-koln-bartnik.github.io/workshop-ai-4-taac/interactions/diagnose-quiz.html){style="color: #ffffff; font-size: 1.0em;"}

:::

::: notes
Zehn Items, drei Antwortoptionen, acht Minuten Solo. Dann vier Minuten Think-Pair-Share am Tisch, drei Minuten Plenum-Auflösung. Das Quiz läuft einmal — keine Wiederholung am Workshop-Ende. Ziel: spontane Einschätzung, keine Recherche, keine Diskussion mit Nachbarn während der Solo-Phase. Bei Bedarf bietet das Widget am Schluss einen Markdown-Export der eigenen Antworten zur Mitnahme.
:::
