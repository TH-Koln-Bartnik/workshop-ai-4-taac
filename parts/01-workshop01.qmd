...
➡️ [Übung 4 — Tutor-Bot systematisch prüfen (Vertiefung: Übung 3 in Workshop 2)](04-uebungen-w2-2026-ws.qmd#sec-test-suite){.assignment-badge} · 22 Min (15 Min Übung + 4 Min TPS + 3 Min Plenum)
::::
...
Jede Übung dauert maximal 15 Minuten und schließt mit Think-Pair-Share und kurzer Plenum-Auflösung. Innerhalb jeder Übung gibt es eine **Erweiterungsfrage für schnelle Studierende** — wer früh fertig ist, vertieft, statt zu warten. Die Discern-Übung *Tutor-Bot systematisch prüfen* wird in Workshop 2 als [Übung 3 — Tutor-Bot Test-Suite](04-uebungen-w2-2026-ws.qmd#sec-test-suite) vertieft; davor stehen zwei kurze Recaps zu Delegate und Describe, der zweistufige [Quellenbindungs-Prompt an der eigenen Prüfungsordnung](04-uebungen-w2-2026-ws.qmd#sec-pruefungsordnung) und das [Tutor-geführte Verstehen der RAGAS-Metriken](04-uebungen-w2-2026-ws.qmd#sec-ragas-tutor).
:::
