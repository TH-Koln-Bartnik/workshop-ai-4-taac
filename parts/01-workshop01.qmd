...
::: callout-note
## BPMN-Modell in Signavio (bis nächste Woche)

- **Signavio Academic Edition** — Account anlegen unter <https://academic.signavio.com/p/explorer> (kostenfrei mit Hochschul-E-Mail, kein Download nötig; Alternative ohne Account: <https://bpmn.io>).
- Den Rechnungseingangsprozess einer Steuerkanzlei als BPMN-Diagramm modellieren und die Aktivitäten als Process-, Cognitive-, Hybrid- oder Mensch-Aktivität markieren — Aufgabenstellung unter [Hausaufgabe — BPMN-Modellierung in Signavio](04-uebungen-w2-2026-ws.qmd#sec-bpmn).
