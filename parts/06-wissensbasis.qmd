...
Über diese vier hinaus stellt RAGAS weitere Metriken bereit — Context Entities Recall, Noise Sensitivity, Answer Semantic Similarity, Answer Correctness (die letzten beiden brauchen eine Referenzantwort). Für eine erste Diagnose genügen die vier Kernmetriken. Eine Untersuchung an einem medizinischen Glaukom-RAG [@pradhan2025glaucoma] demonstriert das typische Setup: das System wurde auf Diagnoseaufgaben gegen Fachärzte verglichen und parallel mit RAGAS bewertet, um Antwortqualität entlang von Faithfulness, Context Precision, Context Recall und Answer Relevancy zu zerlegen.
