...
*Querverweise:* [Übung 3 — Prompt-Umbau und Tutor-Bot](../parts/02-uebungen-w1.qmd#sec-uebung-3) · [Recap B — Prompt-Patterns am Studienalltag](../parts/04-uebungen-w2-2026-ws.qmd#sec-prompt-patterns-recap) · [Grundlagenskript *GenAI in der Lehre*, Prompt-Beispiele-Sammlung](https://th-koln-bartnik.github.io/genai4teaching/kapitel07-appendix02-prompt-sammlung.html){target="_blank"}.
...
*Querverweise:* [Recap A — Prozessmodellierung mit Mermaid](../parts/04-uebungen-w2-2026-ws.qmd#sec-mermaid) · [Hausaufgabe — BPMN in Signavio](../parts/04-uebungen-w2-2026-ws.qmd#sec-bpmn) · [BPMN-Grundlagen](#sec-bpmn).
