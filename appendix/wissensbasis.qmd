...
Diese Seite ist absichtlich als ein einziges, durchsuchbares Dokument angelegt. Stand: 22.09.2026.
...
- **Grundlagen Sprachmodelle und „How to speak"** — [Kapitel 2 von *GenAI in der Lehre*](https://th-koln-bartnik.github.io/genai4teaching/kapitel02.html){target="_blank"} (Bartnik, 2026)
- **Prompt-Beispiele-Sammlung** — [Kapitel 7, Appendix 2](https://th-koln-bartnik.github.io/genai4teaching/kapitel07-appendix02-prompt-sammlung.html){target="_blank"} mit kommentierten Vorlagen für Tutor-Bots, Erklärbots, Constraints und mehr
- **Komplettes Skript** — [genai4teaching.github.io](https://th-koln-bartnik.github.io/genai4teaching/){target="_blank"}
:::
...
*Querverweise:* [Workshop 1, Block 2](../parts/01-workshop01.qmd) (Kurzdurchlauf der vier Kompetenzen) · [Workshop 2, Block K](../parts/03-workshop02.qmd) (Diligence vertieft) · [Übungen Workshop 1](../parts/02-uebungen-w1.qmd) (Anwendung von Delegation, Description, Discernment).
...
*Querverweise:* [Workshop 1, Block 3](../parts/01-workshop01.qmd) · [Übung 2](../parts/02-uebungen-w1.qmd#sec-uebung-2).
...
*Querverweise:* [Übung 2](../parts/02-uebungen-w1.qmd#sec-uebung-2) · [Übung 3](../parts/02-uebungen-w1.qmd#sec-uebung-3).

## Prompt-Pattern-Katalog nach White et al. (2023) {#sec-prompt-patterns}

@white2023prompt katalogisieren sechzehn wiederverwendbare *Prompt-Patterns* — Bauformen, mit denen sich häufige Probleme im Umgang mit Sprachmodellen systematisch lösen lassen. Die Patterns sind keine konkreten Beispiele, sondern Schablonen, die sich auf jede Domäne übertragen lassen. Die Autoren gruppieren die Patterns in sechs Kategorien.

![Sechs Prompt-Kategorien nach White et al. (2023) — jede Kategorie adressiert ein anderes Problem im Umgang mit Sprachmodellen.](../images/describe-6-prompt-kategorien-welche-wofuer-nach-white-et-al-2023.png){fig-alt="Übersicht der sechs Prompt-Kategorien Input Semantics, Output Customization, Error Identification, Prompt Improvement, Interaction und Context Control mit den jeweiligen Zielen nach White et al. 2023"}
...
![Sechs Prompt-Kategorien und die zugeordneten 16 Muster nach White et al. (2023).](../images/describe-6-prompt-kategorien-16-muster-nach-white-et-al-2023.png){fig-alt="Vollständige Übersicht der sechs Prompt-Kategorien mit allen 16 Patterns: Meta Language Creation; Output Automater, Persona, Visualization Generator, Recipe, Template; Fact Check List, Reflection; Question Refinement, Alternative Approaches, Cognitive Verifier, Refusal Breaker; Flipped Interaction, Game Play, Infinite Generation; Context Manager"}
...
Die Stärke des Katalogs liegt im Kombinieren. @white2023prompt empfehlen ausdrücklich, Patterns zu verschränken. Drei Beispiele aus den Workshop-Übungen:
...
*Querverweise:* [Übung 3 — Prompt-Umbau und Tutor-Bot](../parts/02-uebungen-w1.qmd#sec-uebung-3) · [Übung 4 — Prompt-Patterns am Studienalltag (Recap Describe)](../parts/04-uebungen-w2-2026-ws.qmd#sec-prompt-patterns-recap) · [Grundlagenskript *GenAI in der Lehre*, Prompt-Beispiele-Sammlung](https://th-koln-bartnik.github.io/genai4teaching/kapitel07-appendix02-prompt-sammlung.html){target="_blank"}.

*Quelle:* @white2023prompt — *A Prompt Pattern Catalog to Enhance Prompt Engineering with ChatGPT*. <https://arxiv.org/abs/2302.11382>
...
### Modellieren mit dem Camunda Desktop Modeler

Signavio Academic Edition steht Studierenden aktuell nicht mehr zur Verfügung. Empfohlenes Werkzeug: der [Camunda Desktop Modeler](https://docs.camunda.io/downloads/) — kostenfreier Download für Windows, macOS und Linux, kein Account nötig. Eine kurze Einführung geben die Videos auf dem offiziellen [Camunda-YouTube-Kanal](https://www.youtube.com/user/camundaVideo) (Suchbegriff „Camunda Desktop Modeler Tutorial"). Vorgehen: nach der Installation ein neues *BPMN*-Diagramm anlegen, mit *Start-Ereignis* beginnen, *Aktivitäten* aus der Symbolpalette ziehen, mit *Sequenzflüssen* verbinden, *Pool* und *Lanes* nach Rollen aufsetzen, ein *XOR-Gateway* für die erste Entscheidung einbauen, mit einem *Ende-Ereignis* abschließen. Diagramm als PNG oder PDF exportieren. Wer nichts installieren möchte oder kann, weicht auf [bpmn.io](https://bpmn.io) aus — dieselbe quelloffene Modellierungs-Engine (bpmn-js) im Browser, ohne Anmeldung, mit kleinerem Funktionsumfang.
...
*Querverweise:* [Workshop 2, Block I](../parts/03-workshop02.qmd) · [Hausaufgabe — BPMN-Modellierung im Camunda Desktop Modeler](../parts/04-uebungen-w2-2026-ws.qmd#sec-bpmn).
...
*Querverweise:* [Übung 3 Schritt c](../parts/02-uebungen-w1.qmd#sec-uebung-3) (RAG-Tutor mit NotebookLM) · [Übungen Workshop 2 — 2026-WS](../parts/04-uebungen-w2-2026-ws.qmd) · [Workshop 1, Block 5](../parts/01-workshop01.qmd) (Discern, RAGAS-Metriken).
...
7. Bei Bedarf in den Camunda Desktop Modeler überführen für die saubere BPMN-Variante mit Swimlanes.
...
*Querverweise:* [Übung 3 — Prozessmodellierung mit Mermaid (Recap Delegate)](../parts/04-uebungen-w2-2026-ws.qmd#sec-mermaid) · [Hausaufgabe — BPMN im Camunda Desktop Modeler](../parts/04-uebungen-w2-2026-ws.qmd#sec-bpmn) · [BPMN-Grundlagen](#sec-bpmn).
...
*Querverweise:* [Workshop 2, Block J](../parts/03-workshop02.qmd) · Übung UiPath-Bot (derzeit nicht im Programm, siehe parts/04-uebungen-w2-alt.qmd).
...
*Querverweise:* [Workshop 2, Block K](../parts/03-workshop02.qmd).
