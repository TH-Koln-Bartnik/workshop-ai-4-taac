...
- ein eingerichtetes BPMN-Tool (Camunda Desktop Modeler oder bpmn.io) für Workshop 2,
...
2. **BPMN-Werkzeug bereitstellen**
   - [Camunda Desktop Modeler](https://docs.camunda.io/downloads/){target="_blank"} — kostenfreier Download, kein Account nötig (Signavio steht Studierenden aktuell nicht mehr zur Verfügung) oder
   - [bpmn.io](https://bpmn.io){target="_blank"} als freie Web-Variante ohne Installation.
...
- Free-Tier-Dienste sind nicht für Mandantenarbeit geeignet — siehe [Wissensbasis · Recht und Berufsstand](wissensbasis.qmd#sec-recht).
:::
